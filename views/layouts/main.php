        ...
        <div class="container">
            <div class="menu-content">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?= Url::toRoute(['/']) ?>"><img src="/public/images/logo69.png" style="width: 170px;" alt=""></a>
                </div>
                ...
                <div class="col-md-4">
                    <aside class="footer-widget">
                        ...
                        <div class="address">
                            ...
                            <p> г. Курган, ул. Карельцева 32</p>
                            <p> Phone: +9182487732</p>
                        </div>
                    </aside>
                </div>
                ...
                <div class="col-md-4">
                    <aside class="footer-widget">
                        ...
                        <div class="custom-post">
                            ...
                            <div>
                                <span class="p-date">Ноябрь 12, 2021</span>
                            </div>
                        </div>
                    </aside>
                </div>
